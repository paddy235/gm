    ...
    <div class="panel-body nopadding">
        <form id="orgForm" method="post" class="form-bordered">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <div class="radio icheck-silver icheck-inline">
                        <input type="radio" value="0" name="is_sum" id="is_sun1"><label for="is_sun1">否</label>
                    </div>
                    <div class="radio icheck-silver icheck-inline">
                        <input type="radio" value="1" name="is_sum" id="is_sun2"><label for="is_sun2">是</label>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function submitForm() {
        ...
        $.ajax(
            {
                url: "${pageContext.request.contextPath}/user/update",//发送的路径
                data: form,//发送的数据
                type: "post",//发送的方式
                ...
                success: function (data) {
                    if (data.msg = "ok") {
                        ...
                        setTimeout("window.location.href='${pageContext.request.contextPath}/user/users.jsp'", 11000);
