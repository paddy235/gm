...
<script type="text/javascript">
    ...
    function submitForm() {
        ...
        /*$.post('
        ${pageContext.request.contextPath}/org/insert', form, function (data) {
        ...
        ${pageContext.request.contextPath}/org/organizations.jsp';
					}, 11000);

				}, "json");*/
        $.ajax(
            {
                url: "${pageContext.request.contextPath}/org/insert",//发送的路径
                data: form,//发送的数据
                type: "post",//发送的方式
                ...
                success: function (data) {
                    if (data.msg = "ok") {
                        // alert("已提交成功");
                        toastr.success('<strong>成功&nbsp;! </strong>&nbsp;&nbsp;请到数据列表进行查看。');
                        setTimeout("window.location.href='${pageContext.request.contextPath}/org/organizations.jsp'", 11000);
