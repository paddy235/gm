...
<script type="text/javascript">
    ...
    function submitForm() {
        ...
        /*$.post('
        ${pageContext.request.contextPath}/res/insert', form, function (data) {
					if(data == 1){
        ...
        ${pageContext.request.contextPath}/res/resources.jsp';
					}, 11000);
        ...
        $.ajax(
            {
                url: "${pageContext.request.contextPath}/res/insert",//发送的路径
                data: form,//发送的数据
                type: "post",//发送的方式
                ...
                success: function (data) {
                    if (data.msg = "ok") {
                        // alert("已提交成功");
                        toastr.success('<strong>成功&nbsp;! </strong>&nbsp;&nbsp;请到数据列表进行查看。');
                        setTimeout("window.location.href='${pageContext.request.contextPath}/res/resources.jsp'", 11000);
