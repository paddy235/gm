    ...
    <div class="panel-body nopadding">
        <form id="roleForm" method="post" class="form-bordered">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <div class="input-group mb15">
                        <input id="parent_name" class="form-control" type="text" name="organ_name"
                               placeholder="请输入组织信息"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <div class="input-group mb15">
                        <input id="role_uuid" type="hidden" name="role_uuid"/>
...
<script type="text/javascript">
    ...
    function submitForm() {
        ...
        /*$.post('
        ${pageContext.request.contextPath}/duty/insert', form, function (data) {
					if(data == 1){
        ...
        ${pageContext.request.contextPath}/duty/duties.jsp';
					}, 11000);
				}, "json");*/

        $.ajax(
            {
                url: "${pageContext.request.contextPath}/duty/insert",//发送的路径
                data: form,//发送的数据
                type: "post",//发送的方式
                ...
                success: function (data) {
                    if (data.msg = "ok") {
                        // alert("已提交成功");
                        toastr.success('<strong>成功&nbsp;! </strong>&nbsp;&nbsp;请到数据列表进行查看。');
                        setTimeout("window.location.href='${pageContext.request.contextPath}/duty/duties.jsp'", 11000);
